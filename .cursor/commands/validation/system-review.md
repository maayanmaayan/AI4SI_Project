...
- Suggest updates to Layer 1 assets (CURSOR.md, plan templates, commands)
...
- **CURSOR.md updates:** Universal patterns or anti-patterns to document
...
- [ ] Used documented patterns (from CURSOR.md)
...
- **Suggest improvements:** Don't just analyze - actually suggest the text to add to CURSOR.md or commands